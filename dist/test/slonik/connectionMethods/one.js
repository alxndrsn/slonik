...
(0, ava_1.default)('throws an error if result includes unknown property (unrecognized_keys)', async (t) => {
    var _a;
    const pool = await (0, createPool_1.createPool)();
    pool.querySpy.returns({
        rows: [
    ...
    t.is(error.issues.length, 1);
    t.is((_a = error.issues[0]) === null || _a === void 0 ? void 0 : _a.code, 'unrecognized_keys');
});
